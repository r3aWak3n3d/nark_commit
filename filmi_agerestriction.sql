...
LOCK TABLES `agerestriction` WRITE;
/*!40000 ALTER TABLE `agerestriction` DISABLE KEYS */;
INSERT INTO `agerestriction` VALUES (1,'G'),(2,'PG'),(3,'PG-13'),(4,'R');
/*!40000 ALTER TABLE `agerestriction` ENABLE KEYS */;
UNLOCK TABLES;
